class ConversionScene6 extends Phaser.Scene {//giống ConversionScene4, khác là chuyển sang Game3_2
  constructor() {
  ...
  create(){
    ...
    this.ball_2 = this.add.image(935,74,"ball");
  }

  update(){
    if(this.ball_2.x < 903){
