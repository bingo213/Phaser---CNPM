class ConversionScene5 extends Phaser.Scene { //Sau khi chạy thì 2 quả bóng đều nằm bên phải
  constructor() {
  ...
  create(){
    ...
    var ball_2 = this.add.image(965,74,"ball");
  }

  update(){
    if(this.ball_1.x < 935){
