class Game3_2 extends SceneRoot1 {
  ...
  addShapes() {
    this.shapes.push(
      ...
      new Tri(this, config.width / 2 + 310, config.height / 2 + 80, 0, 180, 64, 0, 64, 150), //7
      //Chim non
      new Hex(this, config.width / 2 + 130, config.height / 2 - 71, 40, 40), //8: Thân
      new Cir(this, config.width / 2 + 130, config.height / 2 - 150, 42, 42), //9: Đầu
      new Tri(this, config.width / 2 + 84, config.height / 2 - 200, 0, 48, 20, 0, 40, 48), //10: Mỏ
      new Cir(this, config.width / 2 + 300, config.height / 2 - 71, 35, 35), //11: Thân
      new Cir(this, config.width / 2 + 260, config.height / 2 - 140, 42, 42), //12: Đầu
      new Tri(this, config.width / 2 + 210, config.height / 2 - 185, 0, 48, 20, 0, 40, 48), //13: Mỏ
      new Hex(this, config.width / 2 + 390, config.height / 2 - 69, 40, 40), //14: Thân
      new Cir(this, config.width / 2 + 390, config.height / 2 - 148, 42, 42), //15: Đầu
      new Tri(this, config.width / 2 + 344, config.height / 2 - 198, 0, 48, 20, 0, 40, 48) //16: Mỏ
    );
